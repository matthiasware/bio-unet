...
def get_model(img_size, n_kernels):
    ...
    up_conv5 = Conv2DTranspose(
        n_kernels * 8, (3, 3), strides=(2, 2), padding='same')(conv5)
    ...
    up_conv6 = Conv2DTranspose(
        n_kernels * 4, (3, 3), strides=(2, 2), padding='same')(conv6)
    ...
    up_conv7 = Conv2DTranspose(
        n_kernels * 2, (3, 3), strides=(2, 2), padding='same')(conv7)
    ...
    up_conv8 = Conv2DTranspose(
        n_kernels * 1, (3, 3), strides=(2, 2), padding='same')(conv8)
